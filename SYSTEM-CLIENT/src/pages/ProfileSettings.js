    ...
    <div className="profile-settings container mt-5">
      <Card className="shadow-sm p-4">
        <Card.Body>
          ...
          {user ? (
            <div>
              <h5 className="text-center mb-2">Name: {user.firstName} {user.lastName}</h5>
              <h5 className="text-center mb-2">Email: {user.email}</h5>
              <h5 className="text-center mb-2">Contact Number: {user.contactNumber}</h5>
